...
${OBJECTDIR}/quickmail.o: quickmail.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -D_GNU_SOURCE -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/quickmail.o quickmail.c

${OBJECTDIR}/test_quickmail.o: test_quickmail.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -D_GNU_SOURCE -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/test_quickmail.o test_quickmail.c
